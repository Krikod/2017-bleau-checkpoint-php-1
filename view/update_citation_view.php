...
?>
	<div class="container">
		...
		<div class="row">
			...
			<form class="col s12" action="index.php?page=update_citation_action&id=<?php echo $citation['id'];?>" method="POST">
				<div class="row">
				...
				<div class="row">
					<div class="input-field">
						...
						<input id="content" type="text" name="content" value="<?php echo $citation['content']; ?>" required="">	
					</div>
				</div>
				...
				<div class="row">
					<div class="input-field">
						...
						<input id="chapter" type="text" name="chapter" value="<?php echo $citation['chapter']; ?>" required="">	
					</div>
				</div>
				...
				<div class="row">
 					<div class="input-field">
						...
						<input id="date" type="date" name="date" value="<?php echo $citation['date']; ?>" required="">
					</div>	
				</div>
